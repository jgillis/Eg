...
X=concatenate(([X[1]],2*array(X[2:floor(N/2)])))/N;


figure()
stem(arange(0,10),abs(X[0:10]), 'o')
xlabel('Harmonische')
ylabel('Amplitude')
...
x3=a[0]/2 +a[1]*cos(theta)+a[2]*cos(2*theta);
figure()
plot(theta,x-x3)
xlabel('\theta [rad]')
ylabel('Amplitude')
...
x4=a[0]/2 +a[1]*cos(theta)+a[2]*cos(2*theta)+a[4]*cos(4*theta);
figure()
plot(theta,x-x4)
xlabel('\theta [rad]')
ylabel('Amplitude')
...
x5=a[0]/2 +a[1]*cos(theta)+a[2]*cos(2*theta)+a[4]*cos(4*theta)+a[6]*cos(6*theta);
figure()
plot(theta,x-x5)
xlabel('\theta [rad]')
ylabel('Amplitude')
